...
function mapaDialogoDibujar(nodoMensaje) { 
	...
	$("#main > .svg-session, #main > .svg-mapa").html(""); 

	// Añadir al 'div' el objeto 'svg' que contiene el mapa del diálogo 
	var svgSession = d3.select("#main > .svg-session").append("svg").attr("style", "background-color: #fff;"); 
	var svgMapa = d3.select("#main > .svg-mapa").append("svg").attr("style", "background-color: #fff;"); 
	...
	d3.select("#main > .svg-session").select("svg")
...
function mapaDialogoAgregarNodo(mensaje) {
	...
	var svgSession = d3.select("#main > .svg-session svg"); 
	var svgMapa = d3.select("#main > .svg-mapa svg"); 
...
function mapaDialogoDibujarAncla(anclar, data) { 
	...
	var svgMapa = d3.select("#main > .svg-mapa"); 
